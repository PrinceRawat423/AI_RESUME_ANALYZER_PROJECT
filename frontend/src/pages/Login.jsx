    ...
    <main className="mx-auto flex min-h-[calc(100vh-80px)] max-w-7xl items-center px-4 py-12 sm:px-6 lg:px-8">
      <div className="grid w-full gap-8 lg:grid-cols-2">
        <section className="rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <h1 className="mt-4 text-4xl font-bold">Login to analyze resumes and practice interviews.</h1>
          <p className="mt-4 text-slate-400">
            Upload your resume, get ATS score, missing skills, suggestions, and AI interview questions.
          </p>
        </section>
